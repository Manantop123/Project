	...
	<body>
		...
		<div class="row">
			<div class="col-lg-8 offset-lg-2">
				<div class="full">
					<form name="productform" method="post" action="productcontroller" enctype="multipart/form-data">
					<input type="hidden" name="uid" value="<%=s1.getUid() %>">
						<fieldset>
							...
							<input type="text" name="productname"
								placeholder="enter productname"> <input type="text"
								name="model" placeholder="enter productmodel">
						...
						<input type="text"
								name="price" placeholder="enter productprice">
