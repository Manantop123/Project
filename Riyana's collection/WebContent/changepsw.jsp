	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-8 offset-lg-2">
				<div class="full">
					<form name="changepswform" method="post" action="signupcontroller">
						<fieldset>
							<input type="password" placeholder="Enter your password" name="oldpsw" required /> 
							<input type="password" placeholder="Enter your password" name="newpsw" required />
							<input type="password" placeholder="Enter your password" name="cnewpsw" required /> 
							<input type="submit" value="psw" name="action" />
						</fieldset>
					</form>
				</div>
			</div>
